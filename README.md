...
## **Features**
- **Image upload Interface:** Upload plant leaf images directly from your devic
- **CNN-Based Classification**: Powered by a trained PyTorch Convolutional Neural Network
- **Instant Predictions**: Get results within seconds
...
## **Results**
- Model performs well on common plant diseases and healthy leaves
